...
// loading images
    ...
    spaceship.loadFromFile("data/images/newship.png");
     welcometxt.loadFromFile("interface.jpg");
        ...
        while(InterFace.isOpen())
                       {
                           ...
                           while(InterFace.pollEvent(avent))
                           {
                            ...
                            InterFace.clear();
                           Texture gameovertxt;
                                     gameovertxt.loadFromFile("interface.jpg");
        ...
        Play.display();
                       ...
                       if(x == 2)
                   {
                       while(ABOUT.isOpen())
                       {
                           ...
                           OPTIONS.clear();
                           Texture gameovertxt;
                                     gameovertxt.loadFromFile("about.jpg");
                                     Sprite gameoverspt(gameovertxt);
